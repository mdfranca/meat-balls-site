      ...
      <section class="tm-header-b uk-grid" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin>              
        <div class="uk-width-1-1 uk-width-medium-1-3">
          <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-center">
            ...
            <h3 class="tm-quote">Meat Balls are like music to the stomach. Every bite makes you want to dance</h3>
            </div>
            
            <img class="tm-img-bottom" src="images/mb/mb1.jpg" alt="Meat Balls Italiana" width="400" height="260"></div></div>
            ...
            <div class="uk-width-1-1 uk-width-medium-2-3">
              <div class="uk-panel uk-panel-box uk-text-center">
                  ...
                  <a class="uk-button-primary uk-button-large uk-button" href="#" target="_self">Confira nosso Menu</a>
                  <a class="uk-button-secondary uk-margin-left uk-button-large uk-button" href="?page=contact-us" target="_self">Reserve seu Pedido</a>
